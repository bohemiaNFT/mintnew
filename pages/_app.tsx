...
import { ChakraProvider, extendTheme } from '@chakra-ui/react'; // Removed Box import
import { image, headerText } from 'settings';
import { SolanaTimeProvider } from "@/utils/SolanaTimeContext";

const theme = extendTheme({
  fonts: {
    body: 'var(--font-audiowide)',
...
export default function App({ Component, pageProps }: AppProps) {
  ...
  let endpoint = "https://rpc-devnet.hellomoon.io/289d9654-c6f3-4c13-b7d3-d89293c5945a";
