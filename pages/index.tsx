                        ...
                        export default function Home() {
                          ...
                          const PageContent: React.FC<PageContentProps> = ({ currentImage }) => {
                            ...
                            const progressColor = availableNFTs === 0 ? "red" : "green";
                            const counterBgColor = availableNFTs === 0 ? "red.500" : "green.500";
                            const mintButtonColor = availableNFTs === 0 ? "red" : "green";
                                        ...
                                        <Stack divider={<StackDivider />} spacing='4'>
                                          {loading ? (
                                            ...
                                            <ButtonList
                                              ...
                                              mintButtonColor={mintButtonColor}
                                            />
                                          )}
                                        </Stack>
                                      </CardBody>
